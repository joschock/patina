...
use crate::{
    GCD, allocator::DEFAULT_ALLOCATION_STRATEGY, ensure, error, events::EVENT_DB, locks::tpl_mutex, protocol_db,
...
pub struct SpinLockedGcd {
    ...
    page_table: tpl_mutex::TplMutex<Option<Box<dyn PageTable>>>,
}
